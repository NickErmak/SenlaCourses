...
public enum QueryInputMessage {
	ADD_BOOK("Enter book information using -- as divider (\"title--dd/mm/yyyy--price--description--onStock(true/false)\")"), 
	GET_BOOK_ID("Enter book id"), ADD_ORDER("Enter order name"), GET_ORDER_ID("Enter order id"), 
